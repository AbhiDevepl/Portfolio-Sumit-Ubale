...
class GalleryLoader {
  ...
  renderGallery() {
    ...
    // Hoist gallery data aggregation out of the loop for better performance
  ...
  createGalleryItem(image, index, galleryData = null) {
    ...
    // Using pre-calculated galleryData and a lookup map for category names
    return Core.Media.createItem(
      image,
      index,
      ...
      (catSlug) => {
        ...
        return this.categoryNames[slug] || catSlug;
      }
    );
  }
