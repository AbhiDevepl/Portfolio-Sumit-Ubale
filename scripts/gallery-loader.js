...
class GalleryLoader {
  ...
  renderGallery() {
    ...
    if (this.category === 'all') {
      Object.values(this.data.portfolio.images).forEach(catImages => images.Array.prototype.push.apply(images, catImages));
    } else {
  ...
  getGalleryData() {
    ...
    if (this.category === 'all') {
      ...
      Object.entries(this.data.portfolio.images).forEach(([catSlug, imgs]) => {
        ...
        all.Array.prototype.push.apply(images, enriched);
      });
      return all;
    }
