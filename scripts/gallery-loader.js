...
class GalleryLoader {
  ...
  renderGallery() {
    ...
    grid.innerHTML = '';
    // Performance optimization: Hoist getGalleryData() out of the loop to avoid O(N^2) complexity.
    // The data is pre-computed once and passed as a reference to each gallery item for the Lightbox.
