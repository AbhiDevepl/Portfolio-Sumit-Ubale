...
class GalleryRenderer {
  ...
  createGalleryItem(item, index) {
    ...
    if (isVideo) {
      ...
      if (((window.Core && window.Core.VideoObserver) || null)) {
    ...
    if (isVideo) {
      ...
      if (((window.Core && window.Core.VideoHover) || null)) {
  ...
  openLightbox(index) {
    if (!((window.Core && window.Core.Lightbox) || null)) return;
...
class ModalViewer {
  ...
  init() {
    ...
    if (((window.Core && window.Core.Lightbox) || null)) {
...
class PortfolioGallery {
  ...
  processData(data) {
    const allItems = [];
    const images = ((data.portfolio && data.portfolio.images) || null) || {};
