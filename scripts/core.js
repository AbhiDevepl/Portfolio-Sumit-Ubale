...
(function() {
  ...
  window.Core = {
    /**
     * CACHED PORTFOLIO FETCH WITH PROMISE DEDUPLICATION
     * Utilizes in-memory promise caching and sessionStorage to cache portfolio JSON data,
     * completely avoiding duplicate concurrent network fetches, repeated sessionStorage lookups,
     * and O(N) JSON parsing overhead across components.
     */
    ...
    /**
     * CACHED SERVICES FETCH WITH PROMISE DEDUPLICATION
