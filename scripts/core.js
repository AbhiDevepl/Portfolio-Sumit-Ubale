window.Core = {
  Lightbox: {
    ...
    init: function() {
      ...
      var html = '<div id="lightbox" class="lightbox" aria-hidden="true" role="dialog" aria-modal="true" aria-label="Fullscreen gallery preview">' +
  ...
  Media: {
    createItem: function(image, index, allItems, categoryFormatter) {
      ...
      if (isVideo) {
        ...
        playIcon.innerHTML = '<svg width="28" height="28" viewBox="0 0 24 24" fill="white">' +
