...
// Private in-memory promise caches for request deduplication and instant O(1) resolution
...
window.Core = {
   ...
   * Utilizes in-memory promise caching to deduplicate concurrent network requests and
   * eliminate repeated JSON parsing of the 291KB payload, while backing up to sessionStorage.
   */
   ...
   * Utilizes in-memory promise caching to deduplicate concurrent network requests and
   * eliminate repeated JSON parsing, while backing up to sessionStorage.
   */
