...
class ContentLoader {
  ...
  populateAbout() {
    ...
    const hasPubs = this.data && this.data.socialProof && this.data.socialProof.publications;
    if (publicationsContainer && hasPubs) {
    ...
    const hasAwards = this.data && this.data.socialProof && this.data.socialProof.awards;
    if (awardsContainer && hasAwards) {
    ...
    const hasClients = this.data && this.data.socialProof && this.data.socialProof.clients;
    if (clientsContainer && hasClients) {
