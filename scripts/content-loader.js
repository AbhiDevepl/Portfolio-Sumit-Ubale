...
class ContentLoader {
  ...
  getFilteredItems(category) {
    ...
    if (category === 'all') {
      ...
      Object.keys(this.mediaData).forEach((key) => {
        const categoryItems = this.mediaData[key];
  ...
  renderCategory(category) {
    ...
    items.forEach((item, index) => {
      ...
      el.addEventListener('click', () => {
        const manager = window.GalleryManager;
        const visibleItems = (manager && manager.getVisibleData) ? manager.getVisibleData() : items;
  ...
  populateAbout() {
    ...
    if (publicationsContainer && socialProof && socialProof.publications) {
    ...
    if (awardsContainer && socialProof && socialProof.awards) {
    ...
    if (clientsContainer && socialProof && socialProof.clients) {
