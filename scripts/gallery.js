    ...
    return Array.from(document.querySelectorAll('.gallery-item'))
      ...
      .map(item => {
        ...
        return {
          ...
          title: (function() {
            const el = item.querySelector('.gallery-title');
            return el ? el.textContent : '';
          })(),
          category: (function() {
            const el = item.querySelector('.gallery-category');
            return (el ? el.textContent : '') || item.dataset.category;
          })(),
          type: item.querySelector('video') ? 'video' : 'image',
          poster: (function() {
            const el = item.querySelector('video');
            return el ? el.poster : '';
          })(),
          originalIndex: idx
        };
